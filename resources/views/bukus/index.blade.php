...
<body class="font-sans antialiased">
    <div class="min-h-screen">
        ...
        <h2 class="m-6 text-xl font-semibold text-gray-900 text-center">Daftar Buku</h2>
                ...
                <tbody class="bg-white">
                    @foreach ($bukus as $buku)
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                <div class="text-sm leading-5 text-gray-500">{{ $buku->author }}</div>
                            </td>
                            ...
                            @auth
                                <td
                                    ...
                                    @if ($buku->canBeBorrowed())
                                        <a href="{{ route('peminjamen.create', ['buku' => $buku->id]) }}">Pinjam Buku</a>
                                    @else
